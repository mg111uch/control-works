...
# Realistic steering constants
MAX_STEERING_ANGLE = 35.0  # Maximum steering lock in degrees
MIN_TURN_RADIUS = 30.0  # Minimum turn radius at very low speed (pixels)
MAX_SPEED_FOR_TURNING = 8.0  # Speed at which turn radius is maximum
LOW_SPEED_THRESHOLD = 0.5  # Speed below which turning is limited
